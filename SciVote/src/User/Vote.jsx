  ...
  const positions = [
    {
      ...
      candidates: ["Justin Miguel Dim Light", "Simoan Roy Abella Danger"],
    },
    {
      id: "vicePresident",
      title: "Vice President",
      candidates: ["Czianel Kasi Eh", "Erwin Shinzou Sasageyo"],
    },
    {
      id: "secretary",
      title: "Secretary",
    ...
    },
    {
      id: "treasurer",
      title: "Treasurer",
      candidates: ["Mark Richard Bisaya", "Gian Carlo Esposito", "Joreen Faye"],
    },
    {
      id: "auditor",
      title: "Auditor",
      candidates: ["Mark Robert Binembang", "Jeru Bakulao", "Harolf Barag"],
    },
    {
      id: "pio",
      title: "Public Information Officer",
      candidates: ["Jhonzen Meralco", "Carl Cannot Submit"],
    },
  ];
